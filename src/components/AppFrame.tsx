    ...
    <div className="app-shell">
      <header className="topbar">
        <div className="topbar-inner">
          <Link className="brand" href="/watchlist">
          ...
          <nav className="nav-links" aria-label="Watchlist navigation">
            <Link className="btn" href="/watchlist/add">
              <Plus size={16} aria-hidden />
              Add
            </Link>
            <Link className="btn" href="/watchlist/history">
              <History size={16} aria-hidden />
              History
            </Link>
            <Link className="btn" href="/watchlist/abandoned">
